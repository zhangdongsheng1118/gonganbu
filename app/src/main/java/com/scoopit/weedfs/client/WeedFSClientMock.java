...
public class WeedFSClientMock implements WeedFSClient {
    ...
    @Override
    public int write(WeedFSFile file, Location location, InputStream inputToUpload, String fileName, ProgressListener cb)
            throws IOException, WeedFSException {
        return 0;
    }

    @Override
    public int write(WeedFSFile file, Location location, File localFile, String fileName, ProgressListener cb) throws IOException, WeedFSException {
        return 0;
    }
