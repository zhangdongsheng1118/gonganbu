...
public interface WeedFSClient {
    ...
    int write(WeedFSFile file, Location location, InputStream inputToUpload, String fileName, ProgressListener cb) throws IOException, WeedFSException;
    int write(WeedFSFile file, Location location, File localFile, String fileName, ProgressListener cb) throws IOException, WeedFSException;
