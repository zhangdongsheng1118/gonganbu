...
import com.yixin.tinode.ui.presenter.CreateGroupAtPresenter;
import com.yixin.tinode.ui.presenter.RelayAtPresenter;
 ...
 * @描述 转发
 */
public class RelayActivity extends BaseActivity<IRelayAtView, RelayAtPresenter> implements IRelayAtView {
    ...
    public void init() {
        ...
        drafty = (Drafty) getIntent().getSerializableExtra("drafty");
    }

    @Override
    public Drafty getDrafty() {
        return drafty;
    }
    ...
    public void initView() {
        ...
        mRvSelectedContacts.setVisibility(View.GONE);
    }
    ...
    @Override
    protected RelayAtPresenter createPresenter() {
        return new RelayAtPresenter(this);
    }
