 ...
 * @描述 搜索用户界面
 */
public class SearchMsgActivity extends BaseActivity<ISearchMsgAtView, SearchMsgAtPresenter> implements ISearchMsgAtView, BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    public void initView() {
        ...
        mTopic = Cache.getTinode().getTopic(topic);
        ...
        mEtSearchContent.setHint("搜索聊天记录");
    }
    ...
    @Override
    protected SearchMsgAtPresenter createPresenter() {
        return new SearchMsgAtPresenter(this);
    }
