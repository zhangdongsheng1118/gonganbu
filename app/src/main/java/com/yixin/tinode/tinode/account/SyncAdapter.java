...
class SyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String ACCKEY_SYNC_MARKER = "com.yixin.tinode.sync_marker_contacts";
    private static final String ACCKEY_INVISIBLE_GROUP = "com.yixin.tinode.invisible_group_id";
    ...
    public void onPerformSync(final Account account, final Bundle extras, String authority,
        ...
        try {
            ...
            tinode.subscribe(Tinode.TOPIC_ME, null, null,false).waitResult();
            tinode.subscribe(Tinode.TOPIC_FND, null, null,false).waitResult();
            ...
            if (future.waitResult()) {
                ServerMessage pkt = future.getResult();
