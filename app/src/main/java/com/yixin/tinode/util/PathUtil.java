...
public class PathUtil {
    ...
    public void initDirs(String var1, Context var3) {
        String var4 = var3.getPackageName();
        pathPrefix = "/YiXin/" + var4 + "/";
        this.voicePath = generateVoicePath(var1, var3);
        if (!this.voicePath.exists()) {
            this.voicePath.mkdirs();
        }

        this.filePath = generateFiePath(var1, var3);
        if (!this.filePath.exists()) {
            this.filePath.mkdirs();
        }

        this.imagePath = generateImagePath(var1, var3);
...
/*
    ...
    private static File generateImagePath(String var0, Context var2) {
        String var3 = null;
        if (var0 == null) {
            var3 = pathPrefix + "/image/";
        } else {
            var3 = pathPrefix + var0 + "/image/";
        }

        return new File(getStorageDir(var2), var3);
    }

    private static File generateVoicePath(String var0, Context var2) {
        String var3 = null;
        if (var0 == null) {
            var3 = pathPrefix + "/voice/";
        } else {
            var3 = pathPrefix + var0 + "/voice/";
        }

        return new File(getStorageDir(var2), var3);
    }

    private static File generateFiePath(String var0, Context var2) {
        String var3 = null;
        if (var0 == null) {
            var3 = pathPrefix + "/file/";
        } else {
            var3 = pathPrefix + var0 + "/file/";
        }
