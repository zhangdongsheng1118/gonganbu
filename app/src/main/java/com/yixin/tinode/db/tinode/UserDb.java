...
public class UserDb implements BaseColumns {
    ...
    static final int COLUMN_IDX_NAME = 6;
     ...
     * @return ID of the newly added user
     */
    public static long insert(SQLiteDatabase db, String uid, Date updated, Object pub) {
        ...
        if (pub != null) {
            ...
            if (pub instanceof VCard) {
                values.put(COLUMN_NAME_NAME, ((VCard) pub).fn);
            }
        }
