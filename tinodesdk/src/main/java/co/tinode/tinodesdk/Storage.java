...
public interface Storage {
    ...
    boolean topicUpdateState(Topic topic);
    /** Delete topic */
 ...
 /** Message sent. Returns database ID of the message suitable for
     ...
     *  {@link #msgDelivered(Topic topic, long id, Date timestamp, int seq)}
     */
    long msgSendLocal(Topic topic, Drafty data);
    boolean msgUpdate(long id, Drafty data);
    /**
    ...
    boolean msgFailed(Topic topic, long messageDbId, Drafty data);
