...
public class AEvent {
    ...
    public static void removeListener(String eventID){
        int i;
        EventObj event;
        for(i=0;i<callBackList.size();i++){
            event = callBackList.get(i);
    ...
    //事件类型在这里定义
    public static final String AEVENT_LOGOUT_2                    = "AEVENT_LOGOUT_2";
    public static final String AEVENT_LOGIN_STATUS                 ="AEVENT_LOGIN_STATUS";
    public static final String AEVENT_VOIP_START             ="AEVENT_VOIP_START";
    public static final String AEVENT_VOIP_STOP                 ="AEVENT_VOIP_STOP";
    public static final String AEVENT_GO_MEET_VIDEO                ="AEVENT_GO_MEET_VIDEO";
    public static final String AEVENT_GO_MEET_AUDIO               ="AEVENT_GO_MEET_AUDIO";
    public static final String AEVENT_RED            ="AEVENT_RED";
    public static final String AEVENT_LOCATION           ="AEVENT_LOCATION";
    public static final String AEVENT_PTT           ="AEVENT_PTT";
