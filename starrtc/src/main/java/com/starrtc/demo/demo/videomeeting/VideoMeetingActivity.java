...
public class VideoMeetingActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vMeetingName.setText("视频："+meetingName);
    ...
    private void showAddDialog(){
        ...
        ((EditText)dialog.findViewById(R.id.rtmpurl)).setText(MLOC.PUSH+meetingName);
        ...
        meetingManager.createMeeting(meetingItem, new IXHResultCallback() {
            ...
            public void success(Object data) {
                ...
                try {
                    ...
                    AEvent.notifyListener(AEvent.AEVENT_GO_MEET_VIDEO,true,"[多人视频]"+infostr);
