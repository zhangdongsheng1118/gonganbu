...
public class SettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_rtc);
        View title_left_btn = findViewById(R.id.title_left_btn);
...
//        findViewById(R.id.btn_uploadlogs).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btn_server_set) {
            ...
            dialog.show();
        } else if (i == R.id.btn_audio_codec_type) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            ...
            AlertDialog dialog = builder.create();
            dialog.show();
        } else if (i == R.id.btn_audio_source) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            ...
            AlertDialog dialog = builder.create();
            dialog.show();
        } else if (i == R.id.btn_audio_stream_type) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
        ...
        } else if (i == R.id.hard_encode_switch) {
